...
let components = {
	...
	fontMuli: {
		selector: 'html',
		styles: 'https://fonts.googleapis.com/css?family=Muli:300,400,500,700&display=swap'
	},
	fontAwesome: {
		selector: '[class*="fa-"]',
				...
				switch (node.getAttribute('data-table-mode')) {
					...
					case 'collapse':
						var table2 = $(node).DataTable({
							...
							"columns": [
								{
									"className": 'details-control text-center h5 text-primary',
									"orderable": false,
									"data": null,
									"defaultContent": '+'
								},
	...
	flotchart: {
		...
		init: function (nodes) {
			var options = {
				colors: ['#0052ff', '#feb006', '#1bc773', '#fe355f', '#8bd3fb', '#00c3aa'],
				grid: {
					show: true,
					aboveData: true,
					color: '#dde3e8',
				...
				xaxis: {
					color: '#dde3e8', // color for value in flotchart.scss
				},
				yaxis: {
					color: '#dde3e8' // color for value in flotchart.scss
				},
